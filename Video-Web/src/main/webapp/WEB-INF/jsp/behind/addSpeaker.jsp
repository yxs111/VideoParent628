...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/speaker/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerName" value="${speaker.speakerName}" placeholder="讲师名字">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speakerJob" value="${speaker.speakerJob}" placeholder="讲师职位">
            </div>
        </div>
