...
<html>
	<head>
		...
		function showAddPage(){
			location.href="${pageContext.request.contextPath}/course/insertCourse";
		}
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/course/list2">课程管理</a></li>
      ...
      <tbody>
        <c:forEach items="${pageInfo.list}" var="course" varStatus="status">
            <tr>
	          ...
	          <td><a href="#" onclick="return delSpeakerById(this,'${course.id}','${course.courseTitle}')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
           </tr>
	...
	<div class="container">
		<div class="navbar-right">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<li>
						<a href="${pageContext.request.contextPath}/course/list2?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">
							<span aria-hidden="true">&laquo;</span>
						</a>
					</li>
					<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum" >
						<li><a href="${pageContext.request.contextPath}/course/list2?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
					</c:forEach>


					<li>
						<a href="${pageContext.request.contextPath}/course/list2?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}" aria-label="Next">
