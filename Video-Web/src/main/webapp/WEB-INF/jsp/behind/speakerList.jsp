...
<html>
	<head>
		...
		function showAddPage(){
			location.href="${pageContext.request.contextPath}/speaker/insertSpeaker";
		}
		function delSpeakerById(Obj,id,name){
		 ...
		 Confirm.show('温馨提示：', '确定要删除'+name+'么？', {
                'Delete': {
                    ...
                    'callback': function() {
                    	var param={"id":id};
                    	$.post("${pageContext.request.contextPath}/speaker/deleteSpeakerById",param,function(data){
                    		if(data=='success'){
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="${pageContext.request.contextPath}/speaker/list?name=sdf">主讲人管理</a></li>
					<li ><a href="${pageContext.request.contextPath}/course/list2">课程管理</a></li>
      ...
      <tbody>
        <c:forEach items="${pageInfo.list}" var="speaker" varStatus="status">
            <tr>
	          ...
	          <td><a href="${pageContext.request.contextPath}/speaker/updateSpeaker?id=${speaker.id}"><span class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
